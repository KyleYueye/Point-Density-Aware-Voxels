...
def parse_config():
    ...
    parser.add_argument('--eval_all', type=bool, default=False, help='whether to evaluate all checkpoints')
...
def main():
    ...
    output_dir = Path('/media/disk/02drive/05yueye/code/PDV/output/wanji_models/pdv/default')
    ...
    log_file = eval_output_dir / ('log_eval_%s.log' % datetime.datetime.now().strftime('%Y%m%d-%H%M%S'))
